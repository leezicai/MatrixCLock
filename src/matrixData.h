...
// NVS Key Definitions - Stock Index Settings
// NVS keys are limited to 15 characters, keep these short.
#define NVS_KEY_STOCK_ENABLE "stock_en"
#define NVS_KEY_STOCK_COLOR  "stock_color"
...
// Stock index defaults
// 0 = red marks a gain and green marks a loss (mainland convention, default)
// 1 = green marks a gain and red marks a loss (western convention)
#define DEFAULT_STOCK_ENABLE        true
#define DEFAULT_STOCK_COLOR_MODE    0
...
public:
    ...
    bool getStockEnabled();

    void setStockColorMode(int mode);
    int getStockColorMode();
